...
export function MessageRow({ message, isSelected, onSelect }: MessageRowProps) {
  ...
  return (
    ...
    >
      {/* Read/unread indicator � Material Symbol "mail" */}
      {/* FILL=1 (filled) for unread, FILL=0 (outlined) for read */}
      <span
        className={[
      ...
      <div className="flex-shrink-0 hidden sm:block">
        <span className="font-[Hanken_Grotesk] text-[11px] font-semibold uppercase tracking-[0.08em] text-secondary bg-secondary-container/30 px-2.5 py-1 rounded-full">
          {message.inquiryType}
        </span>
      </div>
