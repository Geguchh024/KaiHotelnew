...
/**
 * Public-site contact / social / about settings form. Extracted from the old
 * SettingsTab so the new Settings hub can compose it alongside Gallery,
 * Sponsors, language and sign-out controls.
 */
