...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../chunks/_tanstack-start-manifest_v-B3g8yZ2Y.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("../chunks/router-cXXbqms1.js").then((n) => n.r),
    Promise.resolve().then(() => start),
    import("../chunks/__23tanstack-start-plugin-adapters-Cwee5PKy.js")
  ]);
  return {
    routerEntry,
    startEntry,
