    ...
    /* @__PURE__ */ jsxs("main", { children: [
      /* @__PURE__ */ jsxs("section", { className: "relative h-[85vh] flex items-center justify-center overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 z-0", children: [
          /* @__PURE__ */ jsx(BlurhashImage, { src: "https://images.unsplash.com/photo-1565008576549-57569a49371d?q=80&w=1258&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", alt: "Kai Hotel", blurhash: "LkH^woxCI=sn}ls,R.sm^LoIR-n%", className: "w-full h-full" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 text-center px-6 max-w-3xl", children: [
          ...
          /* @__PURE__ */ jsx("h1", { className: "font-[EB_Garamond] text-[32px] md:text-[48px] leading-[1.15] tracking-[-0.01em] text-white mb-4", children: t("hero.title") }),
          /* @__PURE__ */ jsx("p", { className: "font-[Hanken_Grotesk] text-[15px] leading-[1.5] text-white/80 max-w-xl mx-auto mb-8", children: t("hero.subtitle") }),
      ...
      /* @__PURE__ */ jsxs("section", { className: "py-20 px-6 max-w-[1280px] mx-auto", children: [
        ...
        rooms.length > 0 ? /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: rooms.slice(0, 3).map((room) => /* @__PURE__ */ jsxs("div", { className: "group cursor-pointer", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-20 bg-surface-container-low", children: /* @__PURE__ */ jsxs("div", { className: "px-6 max-w-[1280px] mx-auto", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: "py-20 bg-surface-container-low overflow-hidden", children: [
        /* @__PURE__ */ jsxs("div", { className: "px-6 max-w-[1280px] mx-auto mb-8 flex items-end justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
          ...
          galleryImages.length > 0 && /* @__PURE__ */ jsx(Link, { to: "/gallery", className: "font-[Hanken_Grotesk] text-[12px] font-semibold uppercase tracking-[0.05em] text-primary border border-primary px-5 py-2 hover:bg-primary/5 transition-colors shrink-0", children: locale === "ka" ? "სრული გალერეა" : "View All" })
        ] }),
        galleryImages.length > 0 ? /* @__PURE__ */ jsxs("div", { className: "px-6 max-w-[1280px] mx-auto", children: [
        ...
        ] }) : /* @__PURE__ */ jsxs("div", { className: "px-6 max-w-[1280px] mx-auto text-center py-12", children: [
