  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      /* @__PURE__ */ jsxs("section", { className: "pt-24 sm:pt-32 pb-8 sm:pb-10 px-4 sm:px-8 max-w-[1280px] mx-auto border-b border-outline-variant/20", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "font-[EB_Garamond] text-[30px] sm:text-[40px] md:text-[52px] leading-[1.1] text-primary", children: locale === "ka" ? "კონსიერჟთან დაკავშირება" : "Connect with the Concierge" })
      ] }),
      /* @__PURE__ */ jsx("section", { className: "border-b border-outline-variant/20 bg-surface-container-low", children: /* @__PURE__ */ jsxs("div", { className: "px-4 sm:px-8 max-w-[1280px] mx-auto py-8 sm:py-10 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8", children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-12 sm:py-20 px-4 sm:px-8 max-w-[1280px] mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-start", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "font-[EB_Garamond] text-[28px] sm:text-[36px] md:text-[44px] leading-[1.15] text-primary mb-4 sm:mb-6", children: locale === "ka" ? "გვიამბეთ თქვენი სურვილების შესახებ" : "Tell Us How We Can Help" }),
