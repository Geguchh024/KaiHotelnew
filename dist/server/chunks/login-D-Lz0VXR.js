...
import { a as Route, b as useAdminAuth } from "./router-cXXbqms1.js";
...
function LoginPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-surface-container-low flex items-center justify-center p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface-container-lowest border border-outline-variant/30 p-6 sm:p-10 w-full max-w-md", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-8 sm:mb-10", children: [
      /* @__PURE__ */ jsx("h1", { className: "font-[EB_Garamond] text-[30px] sm:text-[36px] leading-[1.2] text-primary mb-1", children: "Kai Hotel Bar" }),
