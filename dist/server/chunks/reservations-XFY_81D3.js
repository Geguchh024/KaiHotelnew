...
import { u as useI18n, R as Route } from "./router-cXXbqms1.js";
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("header", { className: "fixed top-0 w-full z-50 border-b border-outline-variant/30 backdrop-blur-md bg-background/80", children: /* @__PURE__ */ jsxs("nav", { className: "flex justify-between items-center px-4 sm:px-6 py-4 max-w-[1280px] mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 sm:gap-3", children: [
        /* @__PURE__ */ jsx("button", { onClick: () => setLocale(locale === "ka" ? "en" : "ka"), className: "font-[Hanken_Grotesk] text-[11px] font-semibold uppercase tracking-[0.05em] text-secondary hover:text-primary transition-colors border border-outline-variant px-2 sm:px-2.5 py-1.5 rounded-sm", children: locale === "ka" ? "EN" : "ქარ" }),
    ...
    /* @__PURE__ */ jsxs("main", { className: "pt-[72px] min-h-screen bg-background", children: [
      /* @__PURE__ */ jsx("div", { className: "bg-primary py-8 sm:py-10 px-4 sm:px-6", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[1080px] mx-auto text-center", children: [
        /* @__PURE__ */ jsx("h1", { className: "font-[EB_Garamond] text-[22px] sm:text-[26px] md:text-[34px] leading-[1.2] text-on-primary mb-2 font-georgian", children: t("res.title") }),
      ...
      /* @__PURE__ */ jsx("div", { className: "border-b border-outline-variant/30 bg-surface-container-lowest", children: /* @__PURE__ */ jsx("div", { className: "max-w-[1080px] mx-auto px-4 sm:px-6 py-3", children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center gap-2 md:gap-6", children: [{
        num: 1,
        label: t("res.step1")
      }, {
        num: 2,
      ...
      /* @__PURE__ */ jsxs("div", { className: "max-w-[1080px] mx-auto px-4 sm:px-6 py-6 sm:py-8", children: [
