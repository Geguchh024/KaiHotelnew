...
function RoomModal({
  ...
  return createPortal(/* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4", role: "dialog", "aria-modal": "true", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative bg-surface-container-lowest border border-outline-variant/30 w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-xl mx-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "p-5 sm:p-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-3 sm:gap-4 mb-5", children: [
          /* @__PURE__ */ jsx("h2", { className: "font-[EB_Garamond] text-[22px] sm:text-[28px] leading-[1.2] text-primary", children: locale === "ka" ? room.nameKa : room.nameEn }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      /* @__PURE__ */ jsxs("section", { className: "pt-24 sm:pt-32 pb-8 sm:pb-10 px-4 sm:px-8 max-w-[1280px] mx-auto border-b border-outline-variant/20", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "font-[EB_Garamond] text-[32px] sm:text-[40px] md:text-[52px] leading-[1.1] text-primary", children: locale === "ka" ? "ჩვენი ნომრები" : "The Suite Collection" })
      ] }),
      /* @__PURE__ */ jsx("section", { className: "py-8 sm:py-10 px-4 sm:px-8 max-w-[1280px] mx-auto border-b border-outline-variant/20", children: /* @__PURE__ */ jsx("p", { className: "font-[Hanken_Grotesk] text-[15px] leading-[1.7] text-secondary max-w-2xl", children: t("rooms.description") }) }),
      /* @__PURE__ */ jsx("section", { className: "py-10 sm:py-16 px-4 sm:px-8 max-w-[1280px] mx-auto", children: rooms.length > 0 ? /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8", children: rooms.map((room) => /* @__PURE__ */ jsxs("div", { className: "group cursor-pointer", onClick: () => setSelectedRoom(room), children: [
      ...
      /* @__PURE__ */ jsx("section", { className: "py-10 sm:py-14 bg-surface-container-low border-y border-outline-variant/20", children: /* @__PURE__ */ jsx("div", { className: "px-4 sm:px-8 max-w-[1280px] mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center gap-10", children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: "py-12 sm:py-20 px-4 sm:px-8 max-w-[1280px] mx-auto text-center", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "font-[EB_Garamond] text-[28px] sm:text-[32px] md:text-[40px] text-primary mb-4 sm:mb-6", children: locale === "ka" ? "მოამზადეთ თქვენი ვიზიტი" : "Plan Your Stay" }),
