...
import { C as ConvexReactClient, a as ConvexProvider } from "../_libs/convex.mjs";
...
function I18nProvider({ children }) {
  const [locale, setLocale] = reactExports.useState("ka");
  const t = (key) => {
    return translations[locale][key] || key;
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(I18nContext.Provider, { value: { locale, setLocale, t }, children });
}
function useI18n() {
...
function AdminAuthProvider({ children }) {
  const [sessionToken, setSessionToken] = reactExports.useState(() => {
    if (typeof window !== "undefined") {
      return localStorage.getItem("adminSessionToken");
    }
    return null;
  });
  const login = reactExports.useCallback((token) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminAuthContext.Provider, { value: { sessionToken, login, logout }, children });
}
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RootDocument, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ConvexProvider, { client: convex, children: /* @__PURE__ */ jsxRuntimeExports.jsx(I18nProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AdminAuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) }) }) });
}
function RootDocument({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "ka", className: "scroll-smooth", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { className: "bg-background text-on-surface", children: [
      children,
      /* @__PURE__ */ jsxRuntimeExports.jsx(Scripts, {})
    ] })
  ] });
}
const $$splitComponentImporter$8 = () => import("./seo-dev-Dw-tLOlL.mjs");
const Route$8 = createFileRoute("/seo-dev")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./rooms-CNQirxbS.mjs");
...
const $$splitComponentImporter$6 = () => import("./reservations-XFY_81D3.mjs");
const reservationSearchSchema = object({
...
const $$splitComponentImporter$5 = () => import("./gallery-D7YboFJ_.mjs");
...
const $$splitComponentImporter$4 = () => import("./contact-CVdWtuwI.mjs");
...
const $$splitComponentImporter$3 = () => import("./index-DW_1up8n.mjs");
...
const $$splitComponentImporter$2 = () => import("./login-D-Lz0VXR.mjs");
...
const $$splitComponentImporter$1 = () => import("../_layout-DGv58QJd.mjs");
...
const $$splitComponentImporter = () => import("./reservations.confirmation._referenceCode-CeW_Cxb0.mjs");
