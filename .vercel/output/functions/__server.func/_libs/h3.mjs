...
var HTTPResponse = (_b = class {
  ...
  get status() {
    return __privateGet(this, _init)?.status || 200;
  }
  get statusText() {
    return __privateGet(this, _init)?.statusText || "OK";
  }
  get headers() {
...
var FrozenHeaders = class extends Headers {
  constructor() {
    super(...arguments);
    __publicField(this, "set", frozen("set"));
    __publicField(this, "append", frozen("append"));
    __publicField(this, "delete", frozen("delete"));
  }
};
