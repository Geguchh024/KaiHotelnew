...
- [ ] 1. Foundations — schema and pure helpers
  - [ ] 1.1 Add the `reservations` table to `convex/schema.ts`
  ...
  - [ ] 1.2 Create `convex/availability.ts` with overlap math and date helpers
  ...
  - [ ] 1.3 Add the transition table and `applyTransition` to `convex/availability.ts`
  ...
  - [ ] 1.4 Add `validateGuestInput` and `generateReferenceCode` to `convex/availability.ts`
  ...
  - [ ] 1.5 Create pure `filterReservations` helper at `src/utils/filterReservations.ts`
  ...
  - [ ] 1.6 Confirm `vitest.config.ts` has an `edge-runtime` project for Convex tests
  ...
  - [ ] 1.7 Checkpoint — Ensure the schema compiles and helpers typecheck
    - Ensure all tests pass, ask the user if questions arise.

- [ ] 2. Pure property tests — lock helper contracts before Convex wiring
  - [ ]* 2.1 Example unit tests for `overlaps` and `applyTransition` in `convex/__tests__/availability.test.ts`
  ...
  - [ ]* 2.2 Property test for availability correctness (Property 3)
  ...
  - [ ]* 2.3 Property test for state machine closure (Property 5)
  ...
  - [ ]* 2.4 Property test for date ordering and past-date rejection (Property 7)
  ...
  - [ ]* 2.5 Property test for guest-count / capacity bounds (Property 8)
  ...
  - [ ]* 2.6 Property test for filter subset refinement (Property 10)
  ...
  - [ ] 2.7 Checkpoint — Ensure all pure tests pass
    - Ensure all tests pass, ask the user if questions arise.

- [ ] 3. Convex functions — `convex/reservations.ts`
  - [ ] 3.1 Scaffold `convex/reservations.ts`
  ...
  - [ ] 3.2 Implement `getAvailabilityForRoom` public query
  ...
  - [ ] 3.3 Implement `getBlockedDatesForRoom` public query
  ...
  - [ ] 3.4 Implement `getByReferenceCode` public query
  ...
  - [ ] 3.5 Implement `create` public mutation
  ...
  - [ ] 3.6 Implement `listPaginated` admin query
  ...
  - [ ] 3.7 Implement `pendingCount` admin query
  ...
  - [ ] 3.8 Implement `transitionStatus` admin mutation
...
- [ ] 4. Convex-level property and integration tests
  - [ ] 4.1 Create `convex/__tests__/reservations.test.ts` scaffold
  ...
  - [ ]* 4.2 Property test — no-double-booking invariant (Property 1)
  ...
  - [ ]* 4.3 Property test — edge-adjacent reservations both succeed (Property 2)
  ...
  - [ ]* 4.4 Property test — cancel releases dates (Property 4)
  ...
  - [ ]* 4.5 Property test — reference code uniqueness and round-trip (Property 6)
  ...
  - [ ]* 4.6 Property test — price calculation (Property 9)
  ...
  - [ ]* 4.7 Property test — unauthorized admin calls rejected (Property 11)
  ...
  - [ ]* 4.8 Full-lifecycle integration test
  ...
  - [ ] 4.9 Checkpoint — Ensure all Convex tests pass
    - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Frontend public reservation flow
  - [ ] 5.1 Rewrite `src/routes/reservations.tsx` to use live Convex data
  ...
  - [ ] 5.2 Wire the Step 3 Confirm button to `api.reservations.create`
  ...
  - [ ] 5.3 Create `src/routes/reservations.confirmation.$referenceCode.tsx`
...
- [ ] 6. Admin panel — Reservations tab
  - [ ] 6.1 Create `src/components/admin/StatusBadge.tsx`
  ...
  - [ ] 6.2 Create `src/components/admin/ReservationRow.tsx`
    ...
    - _(Requirements: 8.3, 8.6, 8.7)_
  - [ ] 6.3 Create `src/components/admin/ReservationDetailPanel.tsx`
  ...
  - [ ] 6.4 Create `src/components/admin/ReservationFilters.tsx`
    ...
    - _(Requirements: 8.4, 8.5; Property: 10)_
  - [ ] 6.5 Create `src/components/admin/tabs/ReservationsTab.tsx`
  ...
  - [ ] 6.6 Update `src/components/admin/AdminSidebar.tsx` to register the new tab
  ...
  - [ ] 6.7 Register the Reservations tab in `src/routes/admin/_layout.tsx`
...
- [ ] 7. Booking.com removal and i18n cleanup
  - [ ] 7.1 Strip booking.com from `src/routes/rooms.tsx`
  ...
  - [ ] 7.2 Strip booking.com from `src/routes/index.tsx`
...
- [ ] 8. Smoke tests and final verification
  - [ ]* 8.1 Grep-based smoke test for Booking.com removal
  ...
  - [ ] 8.2 Typecheck schema + Convex functions with `npx convex dev --once`
